<%@ Page Title="EmployeeLeaves" Language="C#" MasterPageFile="~/Aguai Master1.Master" AutoEventWireup="true" CodeBehind="EmployeeLeaves.aspx.cs" Inherits="Aguai_Leave_Management_System.EmployeeLeaves" %>
                                    ...
                                    <div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand" class="table table-bordered bg-danger" DataKeyNames="ID" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="6">
                                            <Columns>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbtnApprove" class="btn btn-default btn-danger" runat="server" CommandArgument='<%# Eval("ID")%>' CommandName="Approve" Text="Approve" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lbtnReject" class="btn btn-default btn-danger" data-toggle="modal" href="#myModal" runat="server" CommandArgument='<%# Eval("ID")%>' CommandName="Reject" Text="Reject" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
