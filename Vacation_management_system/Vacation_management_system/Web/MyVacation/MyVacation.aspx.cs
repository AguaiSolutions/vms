...
namespace Vacation_management_system.Web.MyVacation
{
    public partial class MyVacation : System.Web.UI.Page
    {
        ...
        protected void btncancel(object sender, EventArgs e)
        {
            ...
            txtCfromdate.Text = gvr.Cells[1].Text;
            txtCtodate.Text = gvr.Cells[2].Text;
            txtCleavetype.Text = gvr.Cells[4].Text;
            txtCapprover.Text = gvr.Cells[5].Text;
            txtCdesc.Text = gvr.Cells[3].Text;
