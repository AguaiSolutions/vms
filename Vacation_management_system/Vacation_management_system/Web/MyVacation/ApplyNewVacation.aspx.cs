...
namespace Vacation_management_system.Web.MyVacation
{
    public partial class ApplyNewVacation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                string query = "SELECT id,first_name,last_name,official_email from employee where id = (select manager_id from manager where employee_id = " + Convert.ToInt32(Session["userId"]) + ")";
        ...
        protected void btnApply_Click(object sender, EventArgs e)
        {
            ...
            if (res)
            {
                ...
                {
                    string query = "insert into leave_management(emp_id,type_id,from_date,to_date,description,approver_id,leaves) values (" + Convert.ToInt32(Session["userId"]) + "," + Convert.ToInt32(drpLeaveType.SelectedValue) + ",'" + txtFromDate.Text + "','" + txtToDate.Text + "','" + txtReason.Text + "'," + Session["Managerid"] + "," + leave + ")";
                    ds.RunCommand(query);
                    ds.Close();
