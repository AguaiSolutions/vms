        ...
        <div id="loginbox" style="margin-top: 90px;" class="mainbox col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-2">
            <div class="panel">
                ...
                <div style="margin-bottom: 25px" class="input-group col-md-8 col-md-offset-2">
                    ...
                    <asp:TextBox ID="txtUsername" class="form-control input-round" name="username" value="" placeholder="Email / Employee No" runat="server" />
                </div>
                ...
                <div style="margin-top: 10px" class="form-group">
                    ...
                    <div class="col-sm-10 col-md-offset-2 controls">
                        <asp:Button Style="margin-right: 40px" ID="butsignin" Text="Sign In" OnClick="butsignin_Click" type="button" class="btn btn-info" runat="server" />
